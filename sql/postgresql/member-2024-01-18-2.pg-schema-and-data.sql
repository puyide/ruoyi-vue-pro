-- Converted from MySQL dump to PostgreSQL (schema + data)
-- Source: member-2024-01-18 2.sql
...
CREATE INDEX IF NOT EXISTS idx_userId ON member_address (user_id);

-- Table: member_config
CREATE TABLE IF NOT EXISTS member_config
(
    id int8 GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    point_trade_deduct_enable int2 NOT NULL,
    point_trade_deduct_unit_price int4 NOT NULL,
    point_trade_deduct_max_price int4,
    point_trade_give_point int8,
    creator varchar(64) DEFAULT '',
    create_time timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updater varchar(64) DEFAULT '',
    update_time timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
    deleted int2 DEFAULT 0 NOT NULL,
    tenant_id int8 DEFAULT 0 NOT NULL,
    CONSTRAINT pk_member_config PRIMARY KEY (id)
);
...
(
    ...
    biz_id varchar(64) DEFAULT '' NOT NULL,
    biz_type int2 DEFAULT 0 NOT NULL,
    ...
    deleted int2 DEFAULT 0 NOT NULL,
    tenant_id int8 DEFAULT 0 NOT NULL,
    CONSTRAINT pk_member_experience_record PRIMARY KEY (id)
);
CREATE INDEX IF NOT EXISTS idx_user_id ON member_experience_record (user_id);
CREATE INDEX IF NOT EXISTS idx_user_biz_type ON member_experience_record (user_id, biz_type);
...
(
    ...
    experience int4 DEFAULT 0 NOT NULL,
    discount_percent int2 DEFAULT 100 NOT NULL,
    icon varchar(255) DEFAULT '' NOT NULL,
    background_url varchar(255) DEFAULT '' NOT NULL,
    status int2 DEFAULT 0 NOT NULL,
    creator varchar(64) DEFAULT '',
    create_time timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updater varchar(64) DEFAULT '',
    ...
    deleted int2 DEFAULT 0 NOT NULL,
    tenant_id int8 DEFAULT 0 NOT NULL,
    CONSTRAINT pk_member_level PRIMARY KEY (id)
);
...
(
    id int8 GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    user_id int8 DEFAULT 0 NOT NULL,
    level_id int8 DEFAULT 0 NOT NULL,
    level int4 DEFAULT 0 NOT NULL,
    discount_percent int2 DEFAULT 100 NOT NULL,
    experience int4 DEFAULT 0 NOT NULL,
    user_experience int4 DEFAULT 0 NOT NULL,
    remark varchar(255) DEFAULT '' NOT NULL,
    ...
    deleted int2 DEFAULT 0 NOT NULL,
    tenant_id int8 DEFAULT 0 NOT NULL,
    CONSTRAINT pk_member_level_record PRIMARY KEY (id)
);
CREATE INDEX IF NOT EXISTS idx_user_id ON member_level_record (user_id);
...
(
    ...
    deleted int2 DEFAULT 0 NOT NULL,
    tenant_id int8 DEFAULT 0 NOT NULL,
    CONSTRAINT pk_member_point_record PRIMARY KEY (id)
);
CREATE INDEX IF NOT EXISTS index_userId ON member_point_record (user_id);
CREATE INDEX IF NOT EXISTS index_title ON member_point_record (title);
...
(
    ...
    deleted int2 DEFAULT 0 NOT NULL,
    tenant_id int8 DEFAULT 0 NOT NULL,
    CONSTRAINT pk_member_sign_in_config PRIMARY KEY (id)
);
...
(
    ...
    deleted int2 DEFAULT 0 NOT NULL,
    tenant_id int8 DEFAULT 0 NOT NULL,
    CONSTRAINT pk_member_sign_in_record PRIMARY KEY (id)
);
